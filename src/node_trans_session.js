...
class NodeTransSession extends EventEmitter {
  ...
  run() {
    ...
    Array.prototype.push.apply(argv, ['-c:v', 'h264', '-preset:v', 'ultrafast', '-c:a', 'aac', '-strict', '-2', '-f', 'hls', '-x264-params', 'keyint=15:min-keyint=15', '-hls_time', '6', '-hls_flags', 'delete_segments', '-hls_list_size', '40', '-http_persistent', '0', mapStr]);
